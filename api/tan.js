...
router.post('/index7', async (req, res, next) => {
  try {
          var userId = req.user._id;
          var tanNo = req.body.tan;
          ...
          const response = await axios.post('https://testapi.karza.in/v2/tan', data, config);
          ...
          switch (response.data['status-code']) {
            ...
            case "103":
              ...
              break;
            case "400":
             Cart.update({owner:userId},{ "$pull": { "items": { "title": 'TAN AUTHENTICATION' } }}, { safe: true, multi:true }, function(err, obj) {
            ...
            System.findOne({company_branch:req.user._id},function(err,system){
              system.Tan_Auth_count = system.Tan_Auth_count + 1;
            ...
            Day.findOne({company_branch:req.user._id},function(err,day){
              ...
              day.save(function (err, day) {
                ...
                Yesterday.findOne({company_branch:req.user._id},function(err,yesterday){
                  yesterday.Tan_Auth_count = day.Tan_Auth_count;
                ...
                day.date = wah;
                day.Tan_Auth_count = day.Tan_Auth_count + 1;
                day.save(function (err, day) {
                    if (err) {
                        return next(err);
                    }
           ...
           localStorage.name = name;
              ...
              const newC = await Cart.removeFormItem(user._id, 'FORM7');
